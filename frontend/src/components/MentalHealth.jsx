...
function MentalHealth() {
  ...
  const quest = [
    { "1":"How often do you feel stressed?", options: ["Rarely", "Occasionally", "Frequently"]},
    { "2": "Do you have any coping mechanisms for stress?", options: ["Yes", "No"]},
    { "3": "How often do you feel anxious?", options: ["Rarely", "Occasionally", "Frequently"]},
    { "4": "Do you have any mental health conditions?", options: ["Yes", "No"]},
    { "5": "Do you seek professional help for mental health?", options: ["Yes", "No"]},
  ];
