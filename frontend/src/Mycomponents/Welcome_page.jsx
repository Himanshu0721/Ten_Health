...
function Welcome_page() {
  ...
  return (
    <div className="container-fluid bg-gradient-to-br from-gray-800 via-gray-900 to-black">
      <div className="day-algin">
        ...
        <h3 className="subtitle" style={{ marginTop: "1.5rem" }}>
        ...
        <Link to="/qna-page">
          <button className="create-btn" style={{ marginTop: "1.5rem" }}>
